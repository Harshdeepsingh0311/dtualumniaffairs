export default function Navbar() {
  return (
<nav className="bg-white border-gray-200 px-2 lg:px-4 py-2.5 nav">
      ...
      <div
        ...
        <ul
          ...
          <li>
              ...
              <div id="dropdownNavbar"  className="absolute z-10  invisible hover:visible font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:uselessclassNamebg-gray-700 dark:uselessclassNamedivide-gray-600">
